...
questions_list.append(
        ...
        Question('Какого iPhone', '9', '10', '7', '12'))
 
questions_list.append(

        Question('Когда была выпущена игра Among Us', '15 июня 2018 года', '16 октября 2018 года', '14 февраля 2019 года ', '25 декабря 2017 года'))

questions_list.append(

        Question('Сколько стоит самый дорогой телефон', '96млн$', '94млн$', '97млн$', '100млн$'))
